<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	pageEncoding="ISO-8859-1" import="uni.deporte.grupo.*"
	%>
<!DOCTYPE html>
<html>
<head>
...
<td><output><%= est.getId_pr()%></output> </td>
</tr>
<tr>

<td>Categoria</td>
<td><input type = "text" name="editardesc" value="<%=est.getId_cat()%>"/></td>
</tr>


<tr>
<td>Descripcion</td>
<td><input type = "text" name="editardesc" value="<%=est.getDescripcion_pr() %>"/> </td>
</tr>
...
<td><input type = "text" name="editarprec" value="<%=est.getPrecio_pr() %>"/> </td>
</tr>

<tr>
<td>Cantidad</td>

<td><input type = "text" name="editarcant" value="<%=est.getCantidad_pr() %>"/> </td>
</tr>
</table>
